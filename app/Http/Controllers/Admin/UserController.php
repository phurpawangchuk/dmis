...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //$users = User::with('role')->paginate(10)->appends($request->query());
        $perPage = 10;  $page = 1;
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route('admin.users.index')->with(['status-success' => "New User created successfully"]);
    }
    ...
    public function update(StoreUserRequest $request, User $user)
    {
       // $user->update(array_filter($request->validated()));
        ...
        return redirect()->route('admin.users.index')->with(['status-success' => "User Updated successfully"]);
    }
    ...
    public function destroy(User $user)
    {
        ...
        $user->delete();
        return redirect()->back()->with(['status-success' => "User Deleted successfully"]);
    }
}
