...
class MailController extends Controller
{
    ...
    public function notification(Request $request){
        ...
        $calanders_data = Calendar::whereRaw('event_date = SUBSTRING(DATE_ADD(NOW(), INTERVAL 1 DAY),1,10)')->get();
        ...
        for($i=0; $i< count($calanders_data); $i++){
            ...
            $details = [
                        ...
                        'body' => 'These is to notify that there is an event on '.$calanders_data[$i]['event_date']." for your necessary action and greeting to be sent to the donors"
                    ];
